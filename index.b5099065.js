 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */();var ch,lh=Rt({apiKey:"AIzaSyANvf5DboogtJf9gd318qK6ilPZ01xrlU8",authDomain:"js-project-team10.firebaseapp.com",projectId:"js-project-team10",storageBucket:"js-project-team10.appspot.com",messagingSenderId:"385026279680",appId:"1:385026279680:web:184d90dda8d043ce558be5",measurementId:"G-TVCY6RM8XF",databaseURL:"https://js-project-team10-default-rtdb.europe-west1.firebasedatabase.app/"}),hh=function(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:Nt(),t=Tt(e,"auth");if(t.isInitialized())return t.getImmediate();var n=dn(e,{popupRedirectResolver:Ja,persistence:[Gi,Ii,Ci]}),r=oe("authTokenSyncURL");if(r){var i=ro(r);_i(n,i,(function(){return i(n.currentUser)})),mi(n,(function(e){return i(e)}))}var a=re("auth");return a&&Ir(n,"http://".concat(a)),n}(lh),dh=function(){var t=arguments.length>0&&void 0!==arguments[0]?arguments[0]:Nt(),n=arguments.length>1?arguments[1]:void 0,r=Tt(t,"database").getImmediate({identifier:n}),i=ie("database");return i&&uh.apply(void 0,[r].concat(e(h)(i))),r}(lh),fh=document.querySelector(".log-in__form"),vh=document.querySelector(".registration__form"),ph=document.querySelector(".sign-out-button"),yh=document.querySelector(".log-in-button"),mh=document.querySelector(".sign-up-btn"),_h=document.querySelector("#auth"),gh=document.querySelector(".authorisation__closeBtn"),kh=(document.querySelector(".movie__watched"),document.querySelector(".movie__queue"),localStorage.getItem("uid"));null!=kh&&ph.classList.contains("is-hidden")&&(ph.classList.remove("is-hidden"),yh.classList.add("is-hidden")),vh.addEventListener("submit",(ch=e(a)(e(o).mark((function t(n){var r,i,a,u;return e(o).wrap((function(t){for(;;)switch(t.prev=t.next){case 0:return n.preventDefault(),r=n.currentTarget,i=r.elements,a=i.email,u=i.password,t.next=4,vi(hh,a.value,u.value).then((function(t){user=t.user,kh=user.uid,localStorage.setItem("uid",kh),th(Zl(dh,"users/"+user.uid),{email:a.value,password:u.value}),ph.classList.remove("is-hidden"),yh.classList.add("is-hidden"),fh.classList.remove("is-hidden"),vh.classList.add("is-hidden"),_h.classList.add("is-hidden");var n=new Date;nh(Zl(dh,"users/"+user.uid),{last_login:n}).then((function(){e(s).Notify.info("User successfully created")})).catch((function(t){e(s).Notify.warning(t)}))})).catch((function(t){t.code;var n=t.message;e(s).Notify.warning(n)}));case 4:case"end":return t.stop()}}),t)}))),function(e){return ch.apply(this,arguments)})),fh.addEventListener("submit",(function(t){t.preventDefault();var n=t.currentTarget.elements,r=n.email,i=n.password;yi(hh,r.value,i.value).then((function(t){ph.classList.remove("is-hidden"),yh.classList.add("is-hidden"),_h.classList.add("is-hidden"),user=t.user,kh=user.uid,localStorage.setItem("uid",kh);var n=new Date;nh(Zl(dh,"users/"+user.uid),{last_login:n}).then((function(){e(s).Notify.info("User successfully logged in")})).catch((function(t){e(s).Notify.warning(t)}))})).catch((function(t){t.code;var n=t.message;e(s).Notify.warning(n)}))})),ph.addEventListener("click",(function(t){var n;t.preventDefault(),(n=hh,Oe(n).signOut()).then((function(){e(s).Notify.info("User successfully signed out"),ph.classList.add("is-hidden"),yh.classList.remove("is-hidden"),localStorage.removeItem("uid",kh)})).catch((function(t){var n=t.message;e(s).Notify.warning(n)}))})),mh.addEventListener("click",(function(e){e.preventDefault(),fh.classList.add("is-hidden"),vh.classList.remove("is-hidden")})),yh.addEventListener("click",(function(e){e.preventDefault(),_h.classList.remove("is-hidden")})),gh.addEventListener("click",(function(e){e.preventDefault(),_h.classList.add("is-hidden"),fh.classList.contains("is-hidden")&&(fh.classList.remove("is-hidden"),vh.classList.add("is-hidden"))}));var bh=i("jcFG7"),wh=i("7ueF0"),Ih=i("1h2Gi");i("1VFfL");var Th=new(0,Ih.FilmsApiService);window.addEventListener("load",(function(){Th.fetchTrendFilms().then((function(e){(0,wh.createMovieCard)(e)})),(0,bh.pagination)()})),i("bdbvb"),i("5iT9w"),i("8Tess"),i("7ueF0"),i("ghnK3"),i("32ZrB"),(0,i("d43SW").default)()}();
//# sourceMappingURL=index.b5099065.js.map
