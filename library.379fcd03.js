 ...
 * limitations under the License.
 */
class wr{get key(){return xe(this._path)?null:ve(this._path)}get ref(){return new xr(this._repo,this._path)}get _queryIdentifier(){const e=vt(this._queryParams),t=D(e);return"{}"===t?"default":t}get _queryObject(){return vt(this._queryParams)}isEqual(e){if(!((e=(0,s.getModularInstance)(e))instanceof wr))return!1;const t=this._repo===e._repo,n=Ie(this._path,e._path),i=this._queryIdentifier===e._queryIdentifier;return t&&n&&i}toJSON(){return this.toString()}toString(){return this._repo.toString()+function(e){let t="";for(let n=e.pieceNum_;n<e.pieces_.length;n++)""!==e.pieces_[n]&&(t+="/"+encodeURIComponent(String(e.pieces_[n])));return t||"/"}(this._path)}constructor(e,t,n,i){this._repo=e,this._path=t,this._queryParams=n,this._orderByCalled=i}}class xr extends wr{get parent(){const e=be(this._path);return null===e?null:new xr(this._repo,e)}get root(){let e=this;for(;null!==e.parent;)e=e.parent;return e}constructor(e,t){super(e,t,new gt,!1)}}class kr{get priority(){return this._node.getPriority().val()}get key(){return this.ref.key}get size(){return this._node.numChildren()}child(e){const t=new fe(e),n=Ir(this.ref,e);return new kr(this._node.getChild(t),n,Ye)}exists(){return!this._node.isEmpty()}exportVal(){return this._node.val(!0)}forEach(e){if(this._node.isLeafNode())return!1;return!!this._node.forEachChild(this._index,((t,n)=>e(new kr(n,Ir(this.ref,t),Ye))))}hasChild(e){const t=new fe(e);return!this._node.getChild(t).isEmpty()}hasChildren(){return!this._node.isLeafNode()&&!this._node.isEmpty()}toJSON(){return this.exportVal()}val(){return this._node.val()}constructor(e,t,n){this._node=e,this.ref=t,this._index=n}}function Cr(e,t){return(e=(0,s.getModularInstance)(e))._checkNotDeleted("ref"),void 0!==t?Ir(e._root,t):e._root}function Ir(e,t){var n,i,r,o;return null===me((e=(0,s.getModularInstance)(e))._path)?(n="child",i="path",o=!1,(r=t)&&(r=r.replace(/^\/*\.info(\/|$)/,"/")),Mi(n,i,r,o)):Mi("child","path",t,!1),new xr(e._repo,we(e._path,t))}function Er(e,t){e=(0,s.getModularInstance)(e),Fi("push",e._path),Li("push",t,e._path,!0);const n=Ki(e._repo),i=yr(n),r=Ir(e,i),o=Ir(e,i);let a;return a=null!=t?Tr(o,t).then((()=>o)):Promise.resolve(o),r.then=a.then.bind(a),r.catch=a.then.bind(a,void 0),r}function Tr(e,t){e=(0,s.getModularInstance)(e),Fi("set",e._path),Li("set",t,e._path,!1);const n=new(0,s.Deferred);return er(e._repo,e._path,t,null,n.wrapCallback((()=>{}))),n.promise}function Nr(e,t){Di("update",t,e._path,!1);const n=new(0,s.Deferred);return function(e,t,n,i){ir(e,"update",{path:t.toString(),value:n});let r=!0;const o=Gi(e),s={};if(F(n,((n,i)=>{r=!1,s[n]=mi(we(t,n),st(i),e.serverSyncTree_,o)})),r)C("update() called with empty data.  Don't do anything."),rr(0,i,"ok",void 0);else{const r=Zi(e),o=Xn(e.serverSyncTree_,t,s,r);zi(e.eventQueue_,o),e.server_.merge(t.toString(),n,((n,o)=>{const s="ok"===n;s||N("update at "+t+" failed: "+n);const a=Kn(e.serverSyncTree_,r,!s),l=a.length>0?ar(e,t):t;Wi(e.eventQueue_,l,a),rr(0,i,n,o)})),F(n,(n=>{const i=hr(e,we(t,n));ar(e,i)})),Wi(e.eventQueue_,t,[])}}(e._repo,e._path,t,n.wrapCallback((()=>{}))),n.promise}class Sr{respondsTo(e){return"value"===e}createEvent(e,t){const n=t._queryParams.getIndex();return new vr("value",this,new kr(e.snapshotNode,new xr(t._repo,t._path),n))}getEventRunner(e){return"cancel"===e.getEventType()?()=>this.callbackContext.onCancel(e.error):()=>this.callbackContext.onValue(e.snapshot,null)}createCancelEvent(e,t){return this.callbackContext.hasCancelCallback?new _r(this,e,t):null}matches(e){return e instanceof Sr&&(!e.callbackContext||!this.callbackContext||e.callbackContext.matches(this.callbackContext))}hasAnyCallback(){return null!==this.callbackContext}constructor(e){this.callbackContext=e}}class Rr{respondsTo(e){let t="children_added"===e?"child_added":e;return t="children_removed"===t?"child_removed":t,this.eventType===t}createCancelEvent(e,t){return this.callbackContext.hasCancelCallback?new _r(this,e,t):null}createEvent(e,t){(0,s.assert)(null!=e.childName,"Child events should have a childName.");const n=Ir(new xr(t._repo,t._path),e.childName),i=t._queryParams.getIndex();return new vr(e.type,this,new kr(e.snapshotNode,n,i),e.prevName)}getEventRunner(e){return"cancel"===e.getEventType()?()=>this.callbackContext.onCancel(e.error):()=>this.callbackContext.onValue(e.snapshot,e.prevName)}matches(e){return e instanceof Rr&&(this.eventType===e.eventType&&(!this.callbackContext||!e.callbackContext||this.callbackContext.matches(e.callbackContext)))}hasAnyCallback(){return!!this.callbackContext}constructor(e,t){this.eventType=e,this.callbackContext=t}}function Ar(e,t,n,i,r){let o;if("object"==typeof i&&(o=void 0,r=i),"function"==typeof i&&(o=i),r&&r.onlyOnce){const t=n,i=(n,i)=>{tr(e._repo,e,a),t(n,i)};i.userCallback=n.userCallback,i.context=n.context,n=i}const s=new br(n,o||void 0),a="value"===t?new Sr(s):new Rr(t,s);return function(e,t,n){let i;i=".info"===me(t._path)?Qn(e.infoSyncTree_,t,n):Qn(e.serverSyncTree_,t,n),ji(e.eventQueue_,t._path,i)}(e._repo,e,a),()=>tr(e._repo,e,a)}function Pr(e,t,n,i){return Ar(e,"value",t,n,i)}!function(e){(0,s.assert)(!An,"__referenceConstructor has already been defined"),An=e}(xr),function(e){(0,s.assert)(!Pn,"__referenceConstructor has already been defined"),Pn=e}(xr);
/**
 * @license
 * Copyright 2020 Google LLC
 *
